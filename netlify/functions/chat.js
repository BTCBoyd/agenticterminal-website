...
const SECURITY = {
  ...
  ALLOWED_ORIGINS: [
    ...
    'https://agenticterminal.netlify.app',
...
function validateAPIKey(event) {
  ...
  // If no API keys configured, allow open access (public chat mode)
  if (SECURITY.VALID_API_KEYS.size === 0) {
    console.log('[AUTH] No API keys configured — open access mode');
  ...
  if (!apiKey) {
    ...
    return { 
      valid: false,
      statusCode: 401, 
      error: 'API key required. Contact us at agenticterminal.ai'
    };
  }
